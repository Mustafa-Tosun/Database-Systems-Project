...
def get_favorites(user_id):
    ...
    query = "SELECT favorite.poem_id,poem.title,poem.year,poem.average,poem.author_id,author.name FROM favorite JOIN poem ON favorite.poem_id=poem.id JOIN author ON poem.author_id=author.id WHERE favorite.user_id=%s"
